...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CreditKiosk.Models.Credit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CreditKiosk.Models.Deposit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 150.0,
                            Comment = "Startkredit",
                            Date = new DateTime(2022, 5, 12, 12, 19, 57, 779, DateTimeKind.Local).AddTicks(4685),
                            PersonId = 1
                        },
                        new
                        {
                            ...
                            Amount = 150.0,
                            Comment = "Startkredit",
                            Date = new DateTime(2022, 5, 12, 12, 19, 57, 779, DateTimeKind.Local).AddTicks(4725),
                            PersonId = 2
                        });
                });
            ...
            modelBuilder.Entity("CreditKiosk.Models.Credit", b =>
                {
                    b.HasOne("CreditKiosk.Models.Purchase", "Purchase")
                        .WithMany()
